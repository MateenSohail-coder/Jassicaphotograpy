        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className=" flex items-center space-x-4">
            <Button
              ...
              className={`transition-all duration-300bg-neutral-800 hover:bg-neutral-700 text-white `}
            >
              Gallery
            </Button>
            <Button
              onClick={() => handleNavigation("#contact")}
              className={`transition-all duration-300 hidden md:block  bg-neutral-800 hover:bg-neutral-700 text-white`}
            >
              Get Quote
            </Button>
          </div>
